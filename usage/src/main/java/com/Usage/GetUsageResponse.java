...
public class GetUsageResponse {
    ...
    public GetUsageResponse withUsage(String usage) {
        this.usage = usage;
        return this;
    }
    ...
    public GetUsageResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetUsageResponse) == false) {
            return false;
        }
        GetUsageResponse rhs = ((GetUsageResponse) other);
